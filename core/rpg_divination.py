...
CARDS = {
    ...
    'chariot': TarotCard('戰車', '「跑快一點吧。至於方向對不對……呵呵。」', '速度 +8、命中率 +3 個百分點', 10),
    'moon': TarotCard('月亮', '「看不清楚，對你反而比較有利。」', '閃避率 +4 個百分點', 10),
    'sun': TarotCard('太陽', '「今天的你，似乎不容易失手呢。」', '武器穩定度下限 +8 個百分點', 10),
    'justice': TarotCard('正義', '「得到多少，就該付出多少。很公平吧？」', '造成傷害 +6%，受到傷害 +4%', 7),
    'temperance': TarotCard('節制', '「再多一滴，也許是藥，也許是毒。」', '本場料理與藥水不會消耗', 5),
    ...
    'wheel': TarotCard('命運之輪', '「它開始轉了。你猜會停在哪裡？」', '個人裝備掉落率 +10 個百分點', 3),
