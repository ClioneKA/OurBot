...
INGREDIENTS = {
    ...
    'fishing:temple:common': Ingredient(GROWTH, 5),
    'fishing:temple:rare': Ingredient(FORTUNE, 6),
    'fishing:temple:weed': Ingredient(NOURISHMENT, 5),
    'farming:tide_lotus': Ingredient(FEAST, 5),
    'farming:sacred_dew_flower': Ingredient(VITALITY, 5),
    'farming:reverse_tide_fruit': Ingredient(ASSAULT, 6),
    'fishing:eclipse:common': Ingredient(GROWTH, 6),
    'fishing:eclipse:rare': Ingredient(FORTUNE, 7),
    'fishing:eclipse:weed': Ingredient(NOURISHMENT, 6),
    'farming:star_ring_wheat': Ingredient(FEAST, 6),
    'farming:nightglow_flower': Ingredient(VITALITY, 6),
    'farming:eclipse_pepper': Ingredient(ASSAULT, 7),
...
PAIRINGS = (
    ...
    ('fishing:temple:common', 'farming:tide_lotus'),
    ('fishing:temple:rare', 'farming:reverse_tide_fruit'),
    ('fishing:temple:weed', 'farming:sacred_dew_flower'),
    ('fishing:eclipse:common', 'farming:star_ring_wheat'),
    ('fishing:eclipse:rare', 'farming:eclipse_pepper'),
    ('fishing:eclipse:weed', 'farming:nightglow_flower'),
)
