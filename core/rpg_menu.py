    ...
    def embed(self, notice=None):
        if self.page == 'home':
            ...
            embed = discord.Embed(title='安安大冒險｜移動', description=
                ...
                '**冒險者酒館**\n'
                '支付金幣張貼不發金幣的額外討伐懸賞，或在目前頻道公開請大家喝一杯。\n\n'
                '**遠野漢娜的裁縫所**\n'
            ...
            embed = discord.Embed(title='安安大冒險｜冒險指南', description=
                ...
                '集齊紅、黃、藍色噴漆罐後，可在背包組成噴漆罐套組並直接使用；中階討伐空閒時會消耗套組，在中階頻道召喚固定四階「城崎諾亞」並自動報名。諾亞裝備可在遠野漢娜的裁縫所消耗單色噴漆並付費染色。\n\n'
                ...
                '遠野漢娜的裁縫所可消耗噴漆罐與 1,000 金幣替諾亞裝備染色；目前的討伐飾品各有一格刺繡格，可支付 500 金幣縫製一項基礎能力 +2 的刺繡，免費初始飾品無法刺繡。\n\n'
            ...
            embed.add_field(name='靈巧、速度與行動順序', value=
                ...
                '暴擊時預設造成 150% 傷害；暴擊傷害由每名角色各自保存、可獨立變動。速度由職業與裝備決定；帶有【準備】詞條的增益優先結算，其餘行動速度高者先，同值隨機。', inline=False)
            ...
            embed.add_field(name='能力如何影響戰鬥', value=
                '實際命中機率＝自身命中值－目標迴避值，最低 10%、沒有上限；同階武器對同階怪物約為 95%，達 100% 即必中（精準射擊也必中）。\n'
